fpath+=( %%HOME%%/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-wbingli-SLASH-zsh-wakatime )
source %%HOME%%/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-wbingli-SLASH-zsh-wakatime/zsh-wakatime.plugin.zsh
